...
const AboutMe = () => {
    const skillList = skills.map((skill, idx) => <img src={skill.icon} alt={`${skill.name}`} title={`${skill.name}`}className="rounded-lg w-12 h-12 md:w-24 lg:w-28 m-2" />);


    return (
        <section id="about" className="px-10 py-10 md:px-20 md:h-screen bg-neutral-100 text-blue-950 block md:flex md:justify-between">
            <div className="container md:my-8 mx-auto text-center order-last md:order-first md:basis-2/3">
                ...
                <p className="mb-8">Outside of coding, I enjoy playing board or video games, playing and watching sports, and spending quality time with family and friends. I believe in maintaining a balanced lifestyle, and I enjoy exploring new hobbies and pushing myself outside my comfort zone. Whether it’s learning new technologies, traveling to new places, or experimenting with new recipes, I’m always eager to expand my horizons and make the most of my personal time.</p>
            </div>
