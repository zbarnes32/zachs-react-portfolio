...
const ProjectCard = (props) => {
    ...
    {/* Project Card */}
            <div className="relative">
                ...
                <div className="flex justify-between rounded-b-lg absolute m-[2px] bottom-0 w-full bg-blue-950 bg-opacity-75 p-5">
                    ...
                    <div className="p-2">
                        <div className="flex justify-end flex-wrap basis-1/2">{project.languages.map((language, idx) => ( <div key={idx} className="mx-2 py-2 px-4 rounded-full text-blue-950 bg-cyan-100 text-sm">{language}</div>
                    ))}</div>
                    </div>
                </div>
            </div>
